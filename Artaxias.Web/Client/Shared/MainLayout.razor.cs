...
using Artaxias.Web.Client.Pages.Account;
...
namespace Artaxias.Web.Client.Shared
{
    public partial class MainLayout
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            {
                NavigationManager.NavigateTo(!_user.Identity.IsAuthenticated ? "/account/login" : $"{NavigationManager.ToBaseRelativePath(NavigationManager.Uri)}");
            }
        }
