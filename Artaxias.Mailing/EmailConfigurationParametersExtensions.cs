...
namespace Artaxias.Mailing
{
    public static class EmailConfigurationParametersExtensions
    {
        ...
        public static EmailConfigurationParameters BuildNewUserCredentialsGeneratedEmail(this EmailConfigurationParameters emailMessage, UserRegistrationGeneratedPasswordEmail parameters)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
            ...
            emailMessage.Subject = "Artaxias Panel credentials generated";
